...
$_SESSION["appid"]    = 100246581; 

//申请到的appkey
//$_SESSION["appkey"]   = "yourappkey"; 
$_SESSION["appkey"]   = "9d92be91b54fc12a2bac73b70dbf16d1"; 

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
//$_SESSION["callback"] = "http://your domain/oauth/get_access_token.php"; 
$_SESSION["callback"] = "http://libsu.com/";

//QQ授权api接口.按需调用
$_SESSION["scope"] = "get_user_info,add_share,list_album,add_album,upload_pic,add_topic,add_one_blog,add_weibo";

$_SESSION["access_token"]="4FCA7BEBE0A7E92299DC4C32232C81C1";
$_SESSION["openid"] = "27881C6A43195AEA97A6BEF9311DBA33";
//print_r ($_SESSION);
?>
