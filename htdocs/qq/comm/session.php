...
{
    //mysql的主机地址
    const db_host = "libsu.com"; //需要第三方指定ip地址 

    //数据库用户名
    const db_user = "chareice";   //需要第三方指定自己的用户名

    //数据库密码
    const db_pwd = "aa362325"; //需要第三方指定自己的库据库密码

    //数据库
    const db_name = "calling";      //需要第三方指定数据库
 ...
 */
define("MAIN_DOMAIN", ".libsu.com");   //设置主域名
