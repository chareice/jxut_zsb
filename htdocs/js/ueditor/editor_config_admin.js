...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,iframeCssUrl: '/style/night.css' //给编辑器内部引入一个css文件
        ...
        ,initialStyle:'body{font-size:12px} table td{padding:0px;border: 1px #124680 solid;} table{border: 0px blue solid;border-collapse: collapse;text-align:center;'   //编辑器内部样式,可以用来改变字体等
